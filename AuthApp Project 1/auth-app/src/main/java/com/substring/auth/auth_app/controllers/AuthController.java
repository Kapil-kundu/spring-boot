...
public class AuthController {
    ...
    public ResponseEntity<TokenResponse> refreshToken(
        ...
        if (!jwtService.isRefreshToken(refreshToken)) {
            throw new BadCredentialsException("Invalid Refesh Token Type");
        }
        ...
        cookieService.addNoStoreHeaders(response);
        return ResponseEntity.ok(TokenResponse.of(newAccessToken, newRefreshToken, jwtService.getAccessTtlSeconds(), "Bearer" ,mapper.map(user, UserDto.class)));
    ...
    private Optional<String> readRefreshTokenFromRequest(RefreshTokenRequest body, HttpServletRequest request) {
        // 1. prefer reading refersh token from cookie
