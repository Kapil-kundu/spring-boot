    ...
    public void onAuthenticationSuccess(HttpServletRequest request, HttpServletResponse response,  Authentication authentication) throws IOException {
        ...
        switch (registrationId) {
            ...
            case "github" -> {
                ...
                String gihubId = oAuth2User.getAttributes().getOrDefault("id", "").toString();
        ...
        //jwt token -- token ke sath frontend pe redirect kardenge

        //refresh:
        // user --> refresh token revoking


        // creating refresh token for frontend ->
        ...
        String refreshJwt = jwtService.generateRefreshToken(user, jti);
